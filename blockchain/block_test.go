...
// func TestBlock_fakeMain(t *testing.T) {
// 	uuid, _ := uuid.Parse("43d03424-693a-4f90-a97d-fdeda3f23df1")
// 	validator := Validator{
// 		UUID:  uuid,
// 		Stake: 100,
// 	}
// 	bc := NewBlockChain([]byte{})
// 	bc.AddBlock("adding gopher driver", validator)
// 	bc.AddBlock("adding uncl phill driver", validator)
// 	bc.AddBlock("adding some random driver", validator)
...
// 				Timestamp:     time.Date(1911, 1, 5, 0, 0, 0, 0, time.UTC),
// 				Data:          []byte(`testing 1 2 3`),
// 				PrevBlockHash: "45364154e052ac703823f79a9ee9b337cdd6e28b99c4c482868cc0bbc061e684",
...
// 			bc.AddBlock("this is the third block", tt.validator)
// 			assert.Equal(t, string(bc.Blocks[len(bc.Blocks)-2].Hash), string(bc.Blocks[len(bc.Blocks)-1].PrevBlockHash))
